...
- **Discovery UX Overhaul (Nov 6, 2025)**: Completely redesigned Discovery from Tinder-style permanent dismissal to browseable experience. Swipe left/X button now skips to next profile without blocking. Previous/Next navigation buttons allow browsing back and forth through all profiles. Position counter shows current profile number. Users can revisit profiles unlimited times before deciding to like or permanently block (via profile menu).
