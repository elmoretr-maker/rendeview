...
- **Chat Monetization (Video-First Strategy)**: 
  ...
  - **Message Credit Pricing (3-Video Reward System)**: Standard pricing ($1.99=20 msgs, $4.99=50 msgs, $9.99=100 msgs @ ~$0.10/msg) BEFORE completing video calls with 3 different people. Reward pricing ($1.99=60 msgs, $4.99=200 msgs, $9.99=500 msgs @ $0.02-0.03/msg) AFTER 3-video threshold. Credits never expire.
  - **Video Messaging**: Short video clips (10-60s based on tier) sendable in chat. Free daily allowance (Free: 3/day, Casual: 10/day, Dating: 25/day, Business: 50/day). Paid bundles beyond limit ($2.99=10, $6.99=30, $14.99=100). Unlocks after completing first video call with person.
  - **Philosophy**: "If you want to text chat, get a different app. We're for people who want to VIDEO date." Text messaging designed to facilitate video dates, not replace them. All friction mechanisms push users toward video calls while rewarding video completion with enhanced messaging capabilities.
